...
import roadmapphase3 from '../assets/roadmapphase3.png';
import roadmapphase2 from '../assets/roadmapphase2.png';
import roadmapphase1 from '../assets/roadmapphase1.png';
    ...
    return (
        <div className='bg-black lg:-mb-10'>
            <div className='z-[20]  relative about flex flex-col justify-center items-center p-4 min-h-screen overflow-clip '>
                ...
                <img src={plankback2} alt="" className='z-[10] lg:hidden rotate-90 flex absolute top-0 w-[1000vw] max-w-none' />
