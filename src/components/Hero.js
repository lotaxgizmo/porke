...
function Hero() {
    ...
    return (
        <div className='overflow-hidden z-20 about relative hero  flex flex-col-reverse lg:flex-row justify-center items-start lg:h-[1000px]'>
            ...
            <div className="right flex flex-col justify-center items-center lg:w-1/2 p-5 lg:p-20">
                ...
                <div className="contract relative lg:mt-0 mt-52">
